...
HD_PWD='C:/Users/jawaidt/Desktop/LAB2PAR3/Lab2Part3/Lab2Part3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_proj.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_proj.tcl -notrace
