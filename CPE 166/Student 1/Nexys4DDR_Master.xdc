...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { clkref                                                                                                       }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { dout[3] }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { dout[0] }]; #IO_L7P_T1_D09_14 Sch=led[4]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { updown }]; #IO_L4N_T0_D05_14 Sch=btnu
